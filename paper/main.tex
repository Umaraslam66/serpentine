...
% --- Color system (loaded early so table option and accent are available) ---
\usepackage[table,dvipsnames]{xcolor}
\definecolor{accent}{RGB}{20,60,110}       % deep navy accent
\definecolor{accentdark}{RGB}{14,42,78}    % near-black navy for heading text
\definecolor{headtint}{RGB}{223,231,243}   % light navy tint for table header rows
\definecolor{zebratint}{RGB}{244,247,251}  % very light tint for alternating rows / abstract
...
\usepackage[font=small,labelfont={bf,color=accent},labelsep=period,skip=6pt]{caption}

% --- Section heading styling (accent numbers, small-caps headings, thin rule) ---
\usepackage{titlesec}
\titleformat{\section}[hang]
  {\normalfont\large\bfseries\scshape\color{accentdark}}
...
% --- Styled title block via titling (large bold accent title + double accent rule) ---
\usepackage{titling}
\setlength{\droptitle}{-2.5em}
\pretitle{\begin{center}\huge\bfseries\color{accentdark}}
\posttitle{\par\end{center}\vspace{5pt}%
  \begin{center}%
    {\color{accent}\rule{\textwidth}{1.4pt}}\\[2.5pt]%
...
% --- Abstract as a distinct block: narrower measure, left accent rule, light tint ---
\usepackage[framemethod=default]{mdframed}
\mdfdefinestyle{abstractstyle}{%
  linewidth=2.5pt, linecolor=accent,
  ...
  leftmargin=22pt, rightmargin=22pt,
  skipabove=6pt, skipbelow=10pt}
\renewenvironment{abstract}{%
  \small
  \begin{mdframed}[style=abstractstyle]%
  \noindent{\bfseries\color{accent}\abstractname.}\hspace{0.6em}\ignorespaces
}{%
  \end{mdframed}}

% --- Running headers from page 2 (fancyhdr): short title left, page right, accent rule ---
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\scshape\color{accentdark}When Mamba Needs Attention}
\fancyhead[R]{\small\color{accentdark}\thepage}
\renewcommand{\headrulewidth}{0.6pt}
\renewcommand{\headrule}{{\color{accent}\hrule height \headrulewidth}}
\fancypagestyle{plain}{%
  \fancyhf{}%
  \fancyfoot[C]{\small\color{accentdark}\thepage}%
  \renewcommand{\headrulewidth}{0pt}}

% --- Table header helper: light accent tint + accent bold text ---
\newcommand{\headrow}{\rowcolor{headtint}}
...
attention layer inserted after layer 2) totals 1{,}213{,}184, which is 4.5\pct{}
...
\midrule
Attention        & 6 (d=128, 8 heads)                       & n/a (permutation-invariant) & 1{,}269{,}760 \\
...
\url{https://github.com/Umaraslam66/serpentine} and archived at
DOI \href{https://doi.org/10.5281/zenodo.21517264}{10.5281/zenodo.21517264}. The mamba-ssm CUDA kernel was
